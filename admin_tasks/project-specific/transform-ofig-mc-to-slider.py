...
important_question_target = {
    ...
    "GradingData": [],
    "Labels": {
        "1": {"Display": "Not important at all"},
        "2": {"Display": "Neutral"},
...
def _preserve_attributes(question, target):
    ...
    attributes_to_preserve = ["DataExportTag", "QuestionDescription", "QuestionID"]
...
def parse_important_question(question):
    ...
    for attribute in attributes_to_edit:
        updated_question[attribute] = question[attribute].split(IMPORTANT_QUESTION_RE)[
            0
        ]
    return updated_question
...
def main():
    ...
    for k, v in questions.items():
        ...
        elif (EASY_QUESTION_RE_1 in question_text) or (
            EASY_QUESTION_RE_2 in question_text
        ):
